...
def run(nayanar, seq_fid_list):
    ...
    BASE = pathlib.Path(r"D:\nalvar\periapuranam\output\day-02") / SLUG
...
if __name__=="__main__":
    import argparse
    DEFAULT_NAYANAR = "ThiruNeelaKanta Yazhpana Nayanar"
    DEFAULT_SEQ_FID = [(1017, "17r3fHuZxbYRGpDolzle0YumT6PQZ4XZ4"), (1018, "1Y4OaoWoX7RplbUwk0nS0pl5auBlCmXvh"), (1019, "1VVxib5k4axr0fUy7BbBWtSM5D74Q3SMC")]
    if len(sys.argv) == 1:
