...
if __name__=="__main__":
    import argparse
    DEFAULT_NAYANAR = "Arivattaya Nayanar"
    DEFAULT_SEQ_FID = [(170, "1C21yY0RBXs9azFVGMCxDdELVcbIBzfvv"), (171, "1fziCDFwNMMFxA4oV-2TlQ1b8dJWSEIHP"), (172, "1YwVdquDnW4k3TPczaid8TdhTB0jOgTiy")]
    if len(sys.argv) == 1:
