...
Tamil already verified (Day06 18/28/32-file stories). Translates each story's
...
DAY = "day-06"
SLUGS = [
    ("chandesura_nayanar","Chandesura Nayanar"),
    ("karaikal_ammaiyaar","Karaikal Ammaiyaar"),
    ("kazharitrarivar_nayanar","Kazharitrarivar Nayanar"),
    ("kannappa_nayanar","Kannappa Nayanar"),
]
