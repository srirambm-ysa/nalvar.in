...
if __name__=="__main__":
    _defaults = {"TirunAlaippOvAr Nayanar": [(200, '1q1sIoRgNBvgrgYUuq6vrgxwHqEVg02i_'), (201, '1GY0d56c7EGn2MhG3ErrO9ulxQ3JSgmr9'), (202, '1mcs0wh4f3f1XCZvs0O_CKDHCIYTwcPFb'), (203, '1Y7MTCkon2a9C6H3i9dT570x97dQ0mMgI'), (204, '1MWDYeHWiTKStjMUXCTir1_XzVijkdybP'), (205, '1dsxniWWlQ27RX7ary17-ehP8GaTqjvDr'), (206, '1Cb_umPRWNVJk1WNWC4_4z8QXz0YzUqIf'), (207, '13Rv7tBEXYlIMrgrbu0mQDEccHbdu92Rp'), (208, '1Cdpcma4wTb3xy7C3yhLkmZk5dJgPQ8-p')]}
    import sys as _sys
    if len(_sys.argv) == 1:
        run("TirunAlaippOvAr Nayanar", [(200, '1q1sIoRgNBvgrgYUuq6vrgxwHqEVg02i_'), (201, '1GY0d56c7EGn2MhG3ErrO9ulxQ3JSgmr9'), (202, '1mcs0wh4f3f1XCZvs0O_CKDHCIYTwcPFb'), (203, '1Y7MTCkon2a9C6H3i9dT570x97dQ0mMgI'), (204, '1MWDYeHWiTKStjMUXCTir1_XzVijkdybP'), (205, '1dsxniWWlQ27RX7ary17-ehP8GaTqjvDr'), (206, '1Cb_umPRWNVJk1WNWC4_4z8QXz0YzUqIf'), (207, '13Rv7tBEXYlIMrgrbu0mQDEccHbdu92Rp'), (208, '1Cdpcma4wTb3xy7C3yhLkmZk5dJgPQ8-p')])
        _sys.exit(0)
    import argparse
