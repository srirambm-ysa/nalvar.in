...
def run(nayanar, seq_fid_list):
    ...
    BASE = pathlib.Path(r"D:\nalvar\periapuranam\output\day-03") / SLUG
...
if __name__=="__main__":
    import argparse
    DEFAULT_NAYANAR = "Eanati Nathar Nayanar"
    DEFAULT_SEQ_FID = [(118, '17oPtSLBCE0ppq_8bRHVbK_CKDXrPqW1Q'), (119, '10dM4fACqLqETSr-KgnRZ1F-RxDjM5dsK'), (120, '1avzM9XRwQkkkvAungreJfNGCYGoiq6OJ'), (121, '1opDkbggKONXYaqwuRDT3BOXVADHq7_T-'), (122, '1jANDdffnL8GWJpULbqMdAVW6MSk6synC'), (123, '1xG1eNEj1ECbY5bHEbSkmFGZO1QwHacLV')]
    if len(sys.argv) == 1:
