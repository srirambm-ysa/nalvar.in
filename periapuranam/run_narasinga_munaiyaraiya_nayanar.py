...
if __name__=="__main__":
    import argparse
    # Day 1 #3 defaults (allow `python run_narasinga_munaiyaraiya_nayanar.py` without args)
    DEFAULT_NAYANAR = "Narasinga Munaiyaraiya Nayanar"
    DEFAULT_SEQ_FID = [(972, "13gUb7rHUF_kUS5KwdvgbgcKJrnidirhJ")]
    if len(sys.argv) == 1:
