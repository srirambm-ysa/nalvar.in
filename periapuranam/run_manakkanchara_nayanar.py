...
if __name__=="__main__":
    import argparse
    DEFAULT_NAYANAR = "Manakkanchara Nayanar"
    DEFAULT_SEQ_FID = [(164, '1mHZPkULADoMDvqNvN_rloikw8OrsSyDI'), (165, '1pMxRMUyiOXzr0JGLSlr33aX5WHpYUci4'), (166, '142i4LhFFxgHQ5N-J_66s0AWHc_pHmG5-'), (167, '1anNjn24kfQc-ENZfkEW5sGXdLfp_woA5'), (168, '1WTX45I0dMHqd2XBeSx1WS9TsPmgJIhCO'), (169, '14i7AIQGcDo126_6dquCkIeckilz3pvRs')]
    if len(sys.argv) == 1:
