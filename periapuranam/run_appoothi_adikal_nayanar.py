...
def run(nayanar, seq_fid_list):
    ...
    DAY = "day-05"  # change per batch: day-01, day-02, ... day-10, day-11+
    ...
    for seq,fid in seq_fid_list:
        ...
        for i in range(chunks):
            ...
            # resume: skip already-good chunks (recover from budget 403 without re-pay)
            if chunk_txt.exists() and chunk_txt.stat().st_size > 500:
                try:
                    _cached = chunk_txt.read_text(encoding="utf-8").strip()
                    if _cached and "[FAILED" not in _cached and len(_cached) > 30:
                        print(f"  chunk {i+1}/{chunks} offset {offset:.0f}s dur {dur:.0f}s size {chunk_path.stat().st_size/1e3:.0f}KB -> cached {len(_cached)} chars skip API")
...
if __name__=="__main__":
    _defaults = {"Appoothi Adikal Nayanar": [(504, '1MRa4YvGHVj0Eesb7dGvCYz3XPpcCArH7'), (505, '10w8plAx_e3jExB5qACiyxZ_6Zhg0rdgc'), (506, '1nXkJYslbEgSFcvWyEb5FlZH9JJH9W7UW'), (507, '1fG_Efop_LiIDh0M80klFYoGBV5WpNL3w'), (508, '1K8KiKDoPOODJYRlhXnuUpD13WsK_DOeB'), (509, '1LjWjyWzFpqlmrabYAeaGmfwlJXWwIujt'), (510, '1rJ5wWHoIPLVslIMY_WhFrViFhQIWbYv3'), (511, '1p-4OdyAtK-C4Hyil2_9kAf38hCve12sN'), (512, '1CmE4fA31thtqfWecr5gG_6okhxx57oHU'), (513, '1B1Lbx85FJRFvc9OrWcXuwdVj72LmCxBo'), (514, '1vqVKk9Rnf9yarVE5ytdkgofzMpJTusL2'), (515, '1-wZfHg0a--polfhiP7dHFrS0oj2NzqxY')]}
    import sys as _sys
    if len(_sys.argv) == 1:
        run("Appoothi Adikal Nayanar", [(504, '1MRa4YvGHVj0Eesb7dGvCYz3XPpcCArH7'), (505, '10w8plAx_e3jExB5qACiyxZ_6Zhg0rdgc'), (506, '1nXkJYslbEgSFcvWyEb5FlZH9JJH9W7UW'), (507, '1fG_Efop_LiIDh0M80klFYoGBV5WpNL3w'), (508, '1K8KiKDoPOODJYRlhXnuUpD13WsK_DOeB'), (509, '1LjWjyWzFpqlmrabYAeaGmfwlJXWwIujt'), (510, '1rJ5wWHoIPLVslIMY_WhFrViFhQIWbYv3'), (511, '1p-4OdyAtK-C4Hyil2_9kAf38hCve12sN'), (512, '1CmE4fA31thtqfWecr5gG_6okhxx57oHU'), (513, '1B1Lbx85FJRFvc9OrWcXuwdVj72LmCxBo'), (514, '1vqVKk9Rnf9yarVE5ytdkgofzMpJTusL2'), (515, '1-wZfHg0a--polfhiP7dHFrS0oj2NzqxY')])
        _sys.exit(0)
    import argparse
