...
if __name__=="__main__":
    import argparse
    DEFAULT_NAYANAR = "Muppodhum Thirumeni Theenduvar"
    DEFAULT_SEQ_FID = [(1002, "1VgO5QrGUo0TCorsR4RCMEGhQgyHIgCFP"), (1003, "1YGso4YxfMSRE3qruvXzVoAwMeUzsibCL"), (1004, "1FUuRWzIKqxKNZBcUDu-xXYvCQsnHm3hy")]
    if len(sys.argv) == 1:
